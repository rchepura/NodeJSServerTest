 ...
 * Modified by Magnet Systems, Inc: force application/octet-stream upload, allow set of HTTP method, pass xhr object to onComplete
 *
...
qq.parseJson = function (json) {
    "use strict";
    if (json.replace(/^\s+|\s+$/g, '').length > 2 && window.JSON && qq.isFunction(JSON.parse)) {
...
qq.UploadHandlerXhr = function (o, uploadCompleteCallback, logCallback) {
    ...
    setParamsAndGetEntityToSend = function (params, xhr, fileOrBlob, id) {
        var formData = new FormData(),
            method = options.demoMode ? "GET" : options.method,
            endpoint = options.endpointStore.getEndpoint(id),
            url = endpoint,
            name = api.getName(id),
            size = api.getSize(id),
    ...
    createUploadHandler: function () {
        ...
        return new qq.UploadHandler({
            ...
            onComplete: function (id, name, result, xhr) {
                ...
                self.options.callbacks.onComplete(id, name, result, xhr);
            },
            onCancel: function (id, name) {
